...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bootstrap */ \"bootstrap\");\n/* harmony import */ var bootstrap__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(bootstrap__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ \"jquery\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue */ \"vue\");\n/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(vue__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _models_mediaSource__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/mediaSource */ \"./Assets/ResponsiveMedia/js/components/responsiveMediaEditor/models/mediaSource.ts\");\n/* harmony import */ var _models_mediaItem__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./models/mediaItem */ \"./Assets/ResponsiveMedia/js/components/responsiveMediaEditor/models/mediaItem.ts\");\n/* harmony import */ var _components_responsiveMediaItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/responsiveMediaItem */ \"./Assets/ResponsiveMedia/js/components/responsiveMediaEditor/components/responsiveMediaItem/index.ts\");\n/* harmony import */ var _utils_createMediaItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/createMediaItem */ \"./Assets/ResponsiveMedia/js/components/responsiveMediaEditor/utils/createMediaItem.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\r\n    return new (P || (P = Promise))(function (resolve, reject) {\r\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\r\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\r\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\r\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\r\n    });\r\n};\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nconst selectors = {\r\n    el: '.responsive-media-field-editor',\r\n    mediaApp: '#mediaApp',\r\n    mediaFieldSelectButton: '.mediaFieldSelectButton',\r\n    modalBody: '.modal-body',\r\n};\r\n/* harmony default export */ __webpack_exports__[\"default\"] = ((initialData, modalBodyElement, breakpoints) => {\r\n    const largestBreakpoint = Math.max(...breakpoints);\r\n    let parsedData = [];\r\n    if (initialData) {\r\n        parsedData = initialData\r\n            ? initialData.map((i) => new _models_mediaItem__WEBPACK_IMPORTED_MODULE_4__[\"default\"](i.sources.map((x) => new _models_mediaSource__WEBPACK_IMPORTED_MODULE_3__[\"default\"](x.breakpoint, x.name, x.path, x.url))))\r\n            : [];\r\n    }\r\n    return new vue__WEBPACK_IMPORTED_MODULE_2___default.a({\r\n        el: selectors.el,\r\n        data: {\r\n            activeBreakpoint: largestBreakpoint,\r\n            activeBreakpointPath: '',\r\n            breakpoints,\r\n            mediaItems: [],\r\n        },\r\n        components: {\r\n            ResponsiveMediaItem: _components_responsiveMediaItem__WEBPACK_IMPORTED_MODULE_5__[\"default\"],\r\n        },\r\n        computed: {\r\n            hasMedia() {\r\n                return this.mediaItems.length > 0;\r\n            },\r\n            value() {\r\n                return JSON.stringify(this.mediaItems.map((x) => {\r\n                    return {\r\n                        sources: x.sources.map((source) => {\r\n                            return {\r\n                                breakpoint: source.breakpoint,\r\n                                path: source.path,\r\n                            };\r\n                        }),\r\n                    };\r\n                }));\r\n            },\r\n        },\r\n        mounted: function () {\r\n            this.mediaItems = parsedData;\r\n        },\r\n        methods: {\r\n            add: function () {\r\n                const self = this;\r\n                jquery__WEBPACK_IMPORTED_MODULE_1___default()(selectors.mediaApp)\r\n                    .detach()\r\n                    .appendTo(jquery__WEBPACK_IMPORTED_MODULE_1___default()(modalBodyElement).find(selectors.modalBody));\r\n                jquery__WEBPACK_IMPORTED_MODULE_1___default()(selectors.mediaApp).show();\r\n                const modal = jquery__WEBPACK_IMPORTED_MODULE_1___default()(modalBodyElement).modal();\r\n                jquery__WEBPACK_IMPORTED_MODULE_1___default()(modalBodyElement)\r\n                    .find(selectors.mediaFieldSelectButton)\r\n                    .off('click')\r\n                    .on('click', function () {\r\n                    return __awaiter(this, void 0, void 0, function* () {\r\n                        if (window.mediaApp.selectedMedias.length) {\r\n                            const selectedMedias = window.mediaApp.selectedMedias;\r\n                            for (var i = 0; i < selectedMedias.length; i++) {\r\n                                self.mediaItems.push(yield Object(_utils_createMediaItem__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(self.breakpoints, selectedMedias[i]));\r\n                            }\r\n                        }\r\n                        window.mediaApp.selectedMedias = [];\r\n                        modal.modal('hide');\r\n                        return true;\r\n                    });\r\n                });\r\n            },\r\n            deleteActiveBreakpoint: function () {\r\n                if (this.mediaItems[0].removeBreakpoint(this.activeBreakpoint)) {\r\n                    this.mediaItems = [];\r\n                }\r\n                //this.setActiveBreakpoint(this.activeBreakpoint);\r\n            },\r\n            deleteItem: function () {\r\n                this.mediaItems = [];\r\n            },\r\n            update: function (args) {\r\n                let mediaItem = args.media;\r\n                const breakpoint = args.breakpoint;\r\n                jquery__WEBPACK_IMPORTED_MODULE_1___default()(selectors.mediaApp)\r\n                    .detach()\r\n                    .appendTo(jquery__WEBPACK_IMPORTED_MODULE_1___default()(modalBodyElement).find(selectors.modalBody));\r\n                jquery__WEBPACK_IMPORTED_MODULE_1___default()(selectors.mediaApp).show();\r\n                const modal = jquery__WEBPACK_IMPORTED_MODULE_1___default()(modalBodyElement).modal();\r\n                jquery__WEBPACK_IMPORTED_MODULE_1___default()(modalBodyElement)\r\n                    .find(selectors.mediaFieldSelectButton)\r\n                    .off('click')\r\n                    .on('click', function () {\r\n                    return __awaiter(this, void 0, void 0, function* () {\r\n                        if (window.mediaApp.selectedMedias.length) {\r\n                            mediaItem.addSource(breakpoint, window.mediaApp.selectedMedias[0]);\r\n                        }\r\n                        window.mediaApp.selectedMedias = [];\r\n                        modal.modal('hide');\r\n                        return true;\r\n                    });\r\n                });\r\n            },\r\n        },\r\n    });\r\n});\r\n\n\n//# sourceURL=webpack:///./Assets/ResponsiveMedia/js/components/responsiveMediaEditor/index.ts?");
